    ...
    <PageTransition>
      <Box>
        ...
        {data.pending_appointments > 0 && (
          <Card mb={6} bg="yellow.50" _dark={{ bg: 'yellow.900', color: 'yellow.100' }} borderLeft="4px solid" borderColor="yellow.400">
            <CardBody>
              <Flex direction={{ base: 'column', md: 'row' }} align={{ base: 'flex-start', md: 'center' }} gap={3}>
                ...
                <Button as={RouterLink} to="/app/agenda" size="sm" ml={{ md: 'auto' }} variant="outline" whiteSpace="nowrap">
                  Ver agenda
                </Button>
              </Flex>
            </CardBody>
